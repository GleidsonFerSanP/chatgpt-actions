...
# IAM role for Lambda with trust policy for Lambda service
...
# IAM policy: allow Lambda to read from SSM Parameter Store and Secrets Manager
resource "aws_iam_policy" "lambda_access_params_secrets" {
    ...
    Statement = [
      ...
      },
      {
        ...
        Action = [
          ...
          "secretsmanager:PutSecretValue"      # 👈 necessário para escrever
        ],
        Resource = "*"
      },
      {
